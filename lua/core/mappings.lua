...
M.general = {
  ...
  n = {
    ...
    -- windows management
    ["<leader>sh"] = { "<C-w>s", "Split window" },
    ["<leader>sv"] = { "<C-w>v", "Vsplit window" },
    ["<leader>se"] = { "<C-w>=", "Make splits equal size" },
    ["<leader>sx"] = { "<cmd> q <CR>", "Close window" },
    ...
    ["<leader>tf"] = { "<cmd> tabnew %<CR>", "Open file in new tab" },
...
M.auto_session = {
  ...
  n = {
    ...
    ["<leader>sl"] = { "<cmd> RestoreSession CR>", "Load session" },
